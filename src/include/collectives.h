...
#define ALLREDUCE_SLICESTEPS (NCCL_STEPS/8)
#define ALLREDUCE_CHUNKSTEPS (NCCL_STEPS/8)
#define ALLGATHER_SLICESTEPS (NCCL_STEPS/8)
#define ALLGATHER_CHUNKSTEPS (NCCL_STEPS/8)
#define REDUCESCATTER_SLICESTEPS (NCCL_STEPS/8)
...
#define NCCL_MAX_SLICE_PER_CHUNK 1  // max value for CHUNKSTEPS/SLICESTEPS, must accord with above
